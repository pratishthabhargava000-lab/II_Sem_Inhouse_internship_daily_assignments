...
<body>
    <header class="bg-light border-bottom">
        ...
        justify-content-between align-items-centre py-3">
        ...
        <!-- Login Button -->
        <a href="logout.php" class="btn btn-primary rounded-pill d-flex justify-content-centre align-items-centre fw-bold"
